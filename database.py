...
async def save_booking(
    telegram_id: int, username: str, date: str, time: str,
    duration: float, sound_engineer: bool, phone: str, email: str,
    client_name: str, comment: str, amount: int, prepayment: int
) -> int:
    async with aiosqlite.connect(DB_NAME) as db:
        await db.execute("""
